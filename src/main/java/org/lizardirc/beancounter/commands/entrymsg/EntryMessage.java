...
class EntryMessage {
    /**
     * The message text itself.  Can be null to indicate no message - in this case, the EntryMessage serves not as a
     * message per se, but as a record of the removal of the entry message.
     */
