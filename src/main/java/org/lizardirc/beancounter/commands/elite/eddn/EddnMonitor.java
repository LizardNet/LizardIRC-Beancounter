...
public class EddnMonitor implements Runnable {
    private final EddnHandler<?> parent;
    private volatile boolean interrupted = false;

    public EddnMonitor(EddnHandler<?> parent) {
        this.parent = parent;
    }
    ...
    public void run() {
        ...
        System.err.println("elite.eddn.EddnMonitor: EDDN ZeroMQ endpoint connected");
