...
public class JournalEntry extends SchemaRef {
    public static final String SCHEMA_ID = "https://eddn.edcd.io/schemas/journal/1";
    ...
    public static String asString(Parser parser, JournalEntry journalEntry) {
        ...
        if (journalEntry.getHeader().getUploaderId().isEmpty()) {
            sb.append("¯\\_(ツ)_/¯");
        } else {
            sb.append(journalEntry.getHeader().getUploaderId());
        }
        sb.append(IrcColors.RESET)
            .append(' ');
