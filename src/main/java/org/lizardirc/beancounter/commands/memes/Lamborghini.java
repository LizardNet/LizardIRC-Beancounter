...
class Lamborghini {
    ...
    private final LamborghiniTransformers transformer;
    ...
    public Lamborghini(String quote, String defaultReplacement, LamborghiniTransformers transformer) {
        this.quote = Objects.requireNonNull(quote);
        this.defaultReplacement = Objects.requireNonNull(defaultReplacement);
    ...
    public String getQuote(String replacementWord) {
        ...
        if (replacementWord == null) {
            word = transform(defaultReplacement);
        } else {
            word = transform(replacementWord);
        }

        return String.format(quote, word);
    }
