    ...
    public void handleCommand(GenericMessageEvent event, List commands, String remainder) {
        ...
        if (commands.get(0).equals(CMD_AIRPORT)) {
            ...
            if (remainder.isEmpty()) {
                event.respond("You have to provide an airport to lookup.  Syntax: " + CMD_AIRPORT + " [airport]; [airport] can be a (partial) name, IATA code, or ICAO code.");
            } else {
