...
class DataHandler {
    ...
    public List<Airport> getByIcaoCode(String icaoCode) throws Exception {
        return getByCode(icaoCodeIndex, icaoCode);
    }

    public List<Airport> getByIataCode(String iataCode) throws Exception {
        return getByCode(iataCodeIndex, iataCode);
    }

    private List<Airport> getByCode(Map<String, List<Airport>> index, String code) throws Exception {
        checkDataReady();
    ...
    public List<Airport> searchByName(String name) throws Exception {
        // Expensive operation!
        checkDataReady();
