...
public class YouTubeVideo {
    ...
    YouTubeVideo(String id, String title, String channelTitle, ZonedDateTime publishedAt, Duration duration, long viewCount, long likeCount, long dislikeCount, long commentCount) {
        this.id = id;
        this.title = title;
