...
public class UrlListenerCommandHandler<T extends PircBotX> implements CommandHandler<T> {

    private final UrlSummariserService urlSummariserService;
    private final AccessControl<T> acl;

    public UrlListenerCommandHandler(UrlSummariserService urlSummariserService, AccessControl<T> acl) {
