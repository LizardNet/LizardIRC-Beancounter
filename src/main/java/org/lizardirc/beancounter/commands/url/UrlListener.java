...
public class UrlListener<T extends PircBotX> extends ListenerAdapter<T> {
    ...
    public UrlListener() {
        ...
        UrlSummariser enwikiSummariser = this.defaultSummariser;
        UrlSummariser redditSummariser = new RedditUrlSummariser();
        ...
        domainMap.put("www.reddit.com", redditSummariser);
    ...
    public void onGenericMessage(GenericMessageEvent<T> event) throws Exception {
        ...
        s.summariseUrl(url, (GenericChannelEvent) event);
    }
}
