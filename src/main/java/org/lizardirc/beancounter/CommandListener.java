...
public abstract class CommandListener<T extends PircBotX> extends ListenerAdapter<T> {
    ...
    /**
     * Returns true if the needle is sufficiently long and is a subsequence of
     * the haystack.
     *
     * The needle is considered to be sufficiently long if it is at least 3
     * characters long, or if it is at least 1/3 as long as the haystack.
     */
