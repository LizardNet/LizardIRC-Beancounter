 ...
 *     <li>It must be in the package or a subpackage of org.lizardirc.beancounter.games (this requirement may be removed
 *     in the future)</li>
 *     <li>It must be annotated with this annotation</li>
 *     <li>It must implement {@link Game}, following the contracts specified in {@code Game}'s Javadocs</li>
 *     <li>
 *         It must provide a public constructor that takes three arguments in this order: {@code GameHandler},
...
public @interface GameEntrypoint {
     ...
     * this condition (see {@link Game#handlePlayerQuit(Player)} (after all, some games involve removal of players
