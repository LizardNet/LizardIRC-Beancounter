...
public interface Game<T extends PircBotX> {
     ...
     */
    void handleActivePhaseCommand(GenericMessageEvent<T> event, Player player, List<String> commands, String remainder);
     ...
     * @param remainder The remainder - i.e., freeform arguments not "predicted" by a subcommand
     */
    default void handleSetupPhaseCommand(GenericMessageEvent<T> event, Player player, List<String> commands, String remainder) {
