...
class ElectionRecord {
    private final Set<Player> yesVotes;
    private final Set<Player> noVotes;
    private final Player presidentialCandidate;
    private final Player chancellorCandidate;
    private final boolean electionSuccessful;

    public ElectionRecord(Set<Player> yesVotes, Set<Player> noVotes, Player presidentialCandidate, Player chancellorCandidate) {
        this.yesVotes = yesVotes;
        this.noVotes = noVotes;
        this.presidentialCandidate = presidentialCandidate;
        this.chancellorCandidate = chancellorCandidate;

        electionSuccessful = yesVotes.size() > noVotes.size();
    }

    public Set<Player> getYesVotes() {
        return yesVotes;
    }

    public Set<Player> getNoVotes() {
        return noVotes;
    }
    ...
    public boolean wasElectionSuccessful() {
        return electionSuccessful;
    }
}
