...
enum RoundPhase {
    ELECTION_NOMINATION("Election - Nomination"),
    ELECTION_VOTE("Election - Voting"),
    LEGISLATIVE_SESSION_PRESIDENT_VOTE("Legislative Session"),
    LEGISLATIVE_SESSION_CHANCELLOR_VOTE("Legislative Session"),
    LEGISLATIVE_SESSION_VETO_POWER_CHECK("Legislative Session"), // Not normally entered
    EXECUTIVE_ACTION("Executive Action");

    private final String asString;

    RoundPhase(String asString) {
