...
final class Helpers {
    private Helpers() {
        throw new IllegalStateException("Utility class may not be instantiated.");
    }

    public static Map<Role, Integer> getRoleCount(int numberOfPlayers) {
        Map<Role, Integer> retval = new EnumMap<>(Role.class);

        switch (numberOfPlayers) {
            case 5:
                retval.put(Role.LIBERAL, 3);
                retval.put(Role.FASCIST, 1);
                break;
            case 6:
                retval.put(Role.LIBERAL, 4);
                retval.put(Role.FASCIST, 1);
                break;
            case 7:
                retval.put(Role.LIBERAL, 4);
                retval.put(Role.FASCIST, 2);
                break;
            case 8:
                retval.put(Role.LIBERAL, 5);
                retval.put(Role.FASCIST, 2);
                break;
            case 9:
                retval.put(Role.LIBERAL, 5);
                retval.put(Role.FASCIST, 3);
                break;
            case 10:
                retval.put(Role.LIBERAL, 6);
                retval.put(Role.FASCIST, 3);
                break;
            default:
                throw new IllegalArgumentException("The game must have between 5 and 10 players, inclusive.");
        }

        retval.put(Role.HITLER, 1);
        return retval;
    }
}
