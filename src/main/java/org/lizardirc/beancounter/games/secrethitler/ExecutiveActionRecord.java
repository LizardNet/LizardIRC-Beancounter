...
class ExecutiveActionRecord {
    private final Consumer<Player> executiveActionUsed;
    private final Player president;
    private final Player target;

    public ExecutiveActionRecord(Consumer<Player> executiveActionUsed, Player president, Player target) {
        this.executiveActionUsed = executiveActionUsed;
        this.president = president;
        this.target = target;
    }

    public Consumer<Player> getExecutiveActionUsed() {
        return executiveActionUsed;
    }
