...
class Commands {
    private final SecretHitler parent;
    private final GameState gameState;
    private final Map<Player, PlayerState> playerStates;
    private final PlayerManager playerManager;
    private final Channel channel;

    public Commands(SecretHitler parent) {
        this.parent = parent;
    ...
    public void handleMyrole(GenericMessageEvent event, Player player) {
        ...
        switch (gameState.getRoundPhase()) {
            case ELECTION_NOMINATION:
                ...
                break;
            case ELECTION_VOTE:
                if (!gameState.getVotingMap().containsKey(player)) {
    ...
    public void handleElectionResults(GenericMessageEvent event, String remainder) {
    ...
    public void handleLegislativeResults(GenericMessageEvent event, String remainder) {
        remainder = remainder.trim();
    ...
    public void handleExecutiveActions(GenericMessageEvent event, String remainder) {
        remainder = remainder.trim();
        ...
        ExecutiveActionRecord executiveActionRecord = gameState.getExecutiveActionRecordForRound(round);

        if (executiveActionRecord == null) {
            event.respond("No Executive Actions were used in round " + round + " (yet).");
            return;
        }

        StringBuilder sb = new StringBuilder("For round ")
            .append(round)
    ...
    public void handleStatus(GenericMessageEvent event) {
        switch (gameState.getRoundPhase()) {
            case ELECTION_NOMINATION:
    ...
    public void handleShowTrack(GenericMessageEvent event, Map<Integer, ExecutiveActions.ExecutiveAction> executiveActionTrack) {
    ...
    public void handleNominate(GenericMessageEvent event, Player player, List<String> commands) {
    ...
    public void handleVote(GenericMessageEvent event, Player player, List<String> commands) {
    ...
    public void handleDiscard(GenericMessageEvent event, Player player, List<String> commands) {
    ...
    public void handleEnact(GenericMessageEvent event, Player player, List<String> commands, Map<Integer, ExecutiveActions.ExecutiveAction> executiveActionTrack) {
        ...
        Policy policyToEnact = legislativeSessionPolicies.remove(policy - 1);
    ...
    public void handleVeto(GenericMessageEvent event, Player player, List<String> commands) {
        if (!RoundPhase.LEGISLATIVE_SESSION_CHANCELLOR_VOTE.equals(gameState.getRoundPhase()) &&
    ...
    public void handleUseAction(GenericMessageEvent event, Player player, List<String> commands) {
