...
class Commands<T extends PircBotX> {
    ...
    public void handleShowTrack(GenericMessageEvent<T> event, Map<Integer, ExecutiveActions.ExecutiveAction> executiveActionTrack) {
    ...
    public void handleEnact(GenericMessageEvent<T> event, Player player, List<String> commands, Map<Integer, ExecutiveActions.ExecutiveAction> executiveActionTrack) {
