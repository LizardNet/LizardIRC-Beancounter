...
enum Role {
    LIBERAL(Party.LIBERALS, "Liberal", "You are a \002Liberal\002.  It is your job to figure out who Hitler is!  The " +
        "Liberals win if five Liberal policies are enacted, OR Hitler is assassinated."),
    FASCIST(Party.FASCISTS, "Fascist", "You are a \002Fascist\002.  It is your job to be manipulative, create confusion," +
        " and take control of the government!  The Fascists and Hitler win if six Fascist policies are enacted, or if" +
