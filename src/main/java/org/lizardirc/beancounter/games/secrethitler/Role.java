...
enum Role {
    LIBERAL(Party.LIBERALS, "Liberal", "You are a \002Liberal\002.  It is your job to figure out who the Hitler is!  The " +
        "Liberals win if five Liberal policies are enacted, OR the Hitler is assassinated."),
    FASCIST(Party.FASCISTS, "Fascist", "You are a \002Fascist\002.  It is your job to be manipulative, create confusion," +
        " and take control of the government!  The Fascists and the Hitler win if six Fascist policies are enacted, or if " +
        "the Hitler is elected Chancellor any time after the third Fascist policy has been enacted."),
    HITLER(Party.FASCISTS, "Hitler", "You are the \002Hitler\002!  It is your job to not draw suspicion to yourself, and" +
        " to be elected Chancellor!  You and the Fascists win if six Fascist policies are enacted, or if you are elected" +
        " Chancellor any time after the third Fascist policy has been enacted.");
