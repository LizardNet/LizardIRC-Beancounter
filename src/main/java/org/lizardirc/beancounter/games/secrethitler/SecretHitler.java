...
@GameEntrypoint(getCommandName = "secrethitler", requiresChanops = true)
...
public class SecretHitler<T extends PircBotX> implements Game<T> {
    ...
    @Override
    public String getSetupPhaseHelp(GenericMessageEvent<T> event, List<String> commands) {
        return null;
    }
    ...
    @Override
    public void playerQuit(User player) {
