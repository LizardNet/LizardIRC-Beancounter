...
@GameEntrypoint(properName = "Secret Hitler", commandName = "secrethitler", minimumPlayers = 5, maximumPlayers = 10,
    requiresChanops = true, longDescription = "A secret identity game inspired by Werewolf and Mafia")
...
public class SecretHitler<T extends PircBotX> implements Game<T> {
    ...
    public SecretHitler(GameHandler<T> gameHandler) {
    ...
    @Override
    public void playerQuit(Channel channel, User user) {
