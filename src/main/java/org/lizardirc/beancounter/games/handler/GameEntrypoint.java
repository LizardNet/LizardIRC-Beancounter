 ...
 *     <li>
 *         It must provide a public constructor that takes two arguments in this order: {@code GameHandler<T>},
 *         {@code List<}{@link Player}{@code >}, {@code Channel}
 *         <ul>
...
public @interface GameEntrypoint {
     ...
     * Usually, this will be the proper name, but without spaces and possibly shortened for ease of use.
     *
     ...
     * this condition (see {@link Game#playerQuit(Player)} (after all, some games involve removal of players
     ...
     *
     * This advises the GameHandler whether or not the game needs to be able to acceot commands in private message.  If
     ...
     * They will only be allowed to join multiple games if none of the games have this set to true.
     *
